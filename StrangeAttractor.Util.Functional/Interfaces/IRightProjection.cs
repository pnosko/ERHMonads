...
namespace StrangeAttractor.Util.Functional.Interfaces
{
	public interface IRightProjection<out TLeft, out TRight> : IValue<TRight>, IOptionalValue<TRight>
	{
        ...
        //IEither<TResultLeft, TResultRight> SelectMany<TResultLeft, TIntermediate, TResultRight, TOtherResultRight>(Func<TRight, ILeftProjection<TIntermediate, TOtherResultRight>> intermediate, Func<TRight, TIntermediate, TResultRight> selector);
	}
}