...
namespace StrangeAttractor.Util.Functional.Interfaces
{
    public interface IValidation<out TError, out TValue> : IValue<TValue>, IOptionalValue<TValue>
    {
        ...
        IValidation<TResultError, TResultValue> SelectMany<TResultValue, TIntermediate, TResultError>(Func<TValue, IValidation<TResultError, TIntermediate>> intermediate, Func<TValue, TIntermediate, TResultValue> selector);
        //IValidation<TResultError, TResultValue> SelectMany<TResultValue, TIntermediate, TResultError>(Func<TValue, IFailProjection<TIntermediate, TResultValue>> intermediate, Func<TValue, TIntermediate, TResultValue> selector);
    }
}
