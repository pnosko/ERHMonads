...
{
    internal struct Right<TError, TValue> : IDisjunction<TError, TValue>, IEquatable<IDisjunction<TError, TValue>>
    {
        private readonly TValue _value;

        public Right(TValue value)
        {
            this._value = value;
        }
        ...
        {
            return Disjunction.Right<TError, TResultValue>(selector(this.Value));
        }
        ...
        {
            return Disjunction.Left<TValue, TError>(this.Value);
        }
    }
}
